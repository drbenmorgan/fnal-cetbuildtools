...
function(_verify_cc COMPILER)
  ...
  if(NOT (CMAKE_C_COMPILER MATCHES "^${escaped_path}\$"))
    message(FATAL_ERROR "CMAKE_C_COMPILER set to ${CMAKE_C_COMPILER}: expected match to \"^${escaped_path}\\\$\".\n"
...
function(_verify_cxx COMPILER)
  ...
  set(compiler_ref "${cr_dir}/${cr_name}")
  cet_regex_escape("${compiler_ref}" escaped_path)
  if(NOT (CMAKE_CXX_COMPILER MATCHES "^${escaped_path}\$"))
    message(FATAL_ERROR "CMAKE_CXX_COMPILER set to ${CMAKE_CXX_COMPILER}: expected match to \"^${escaped_path}\\\$\".\n"
