...
if ( ${product_version_less} MATCHES "TRUE" )
  find_library( ROOT_REFLEX   NAMES Reflex PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_CINT     NAMES Cint   PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_CINTEX   NAMES Cintex PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_CORE     NAMES Core   PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_MATHCORE NAMES MathCore PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_HIST     NAMES Hist   PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_TREE     NAMES Tree   PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_PHYSICS  NAMES Physics PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_GRAF     NAMES Graf   PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_RIO      NAMES RIO    PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_NET      NAMES Net    PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_MATRIX   NAMES Matrix PATHS $ENV{ROOTSYS}/lib/root )
  find_library( ROOT_THREAD   NAMES Thread PATHS $ENV{ROOTSYS}/lib/root )
else()
